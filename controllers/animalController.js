...
import {Animal, Type, TypeAnimal} from '../models/models.js';
...
class AnimalController {
    async create(req, res, next) {
        try {
            ...
            let fileName1 = img_1 ? uuidv4() + ".jpg" : null;
            let fileName2 = img_2 ? uuidv4() + ".jpg" : null;
            let fileName3 = img_3 ? uuidv4() + ".jpg" : null;
            let fileName4 = img_4 ? uuidv4() + ".jpg" : null;
